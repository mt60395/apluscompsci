...
public class SortsRunner
{
     ...
     */
    public static boolean isSorted(int[] arr, int[] original)
    {
        ...
        System.out.println("return check 2");
        if(index == arr.length - 1) {
            System.out.println("return check 3");
        ...
        else if(index < arr.length - 1 && arr[index] > arr[index+1]) // possible descend
        {
            for(int i = index+2; i < arr.length; i++)
                if(arr[i] > arr[i-1]) {
                    System.out.println("return check 4");
                    return false;
                }
        }
        else // sort for ascend
        {
             for(int i = index+2; i < arr.length; i++)
                if(arr[i] < arr[i-1]) {
                    System.out.println("return check 5");
                    return false;
                }
        }
