...
public class ImageEnhancerWithUndoAndRedo extends Component implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        undoItem.setEnabled(undoStack.isEmpty()? false:true);
        redoItem.setEnabled(redoStack.isEmpty()? false:true);
        return;     	
    }
    ...
    public void run() {
        JFrame f = new JFrame("Image Enhancer WITH Undo AND Redo"); // Students should update this.
