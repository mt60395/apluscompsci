...
//        }
    ...
    public void everything() {
        ...
        for (int i = 0; i < 1000; i++) {
            if (i < 500) {
                list.add(0, "" + i);
                ll.add(0, "" + i);
                assertEquals(ll.get(0), list.get(0));
                assertEquals(ll.toString(), list.toString());
            } else {
                list.add(list.size(), "" + i);
                ll.add(ll.size(), "" + i);
                assertEquals(ll.get(ll.size() - 1), list.get(list.size() - 1));
                assertEquals(ll.toString(), list.toString());
            }
        }
        assertEquals(ll.toString(), list.toString());
        ...
        // forwards
        for (int i = 0; i < ll.size(); i++) {
            assertEquals(ll.get(i), list.get(i));
        }
        assertEquals(ll.toString(), list.toString());
        // and backwards
        for (int i = ll.size() - 1; i >= 0; i--) {
        ...
        assertEquals(list.size(), ll.size());
        for (int i = 1; i < ll.size(); i += 66) {
            String item1 = ll.remove(i);
            String item2 = list.remove(i);
            assertEquals(item1, item2);
            assertEquals(ll.indexOf(item1), list.indexOf(item2));
            assertEquals(list.toString(), ll.toString());
        }
        assertEquals(list.toString(), ll.toString());
    ...
    public void removeMiddle() {
        ...
        assertEquals("0123456789111213141516171819", printListForwards(lst));
        assertEquals("1918171615141312119876543210", printListBackwards(lst));
    ...
    public void removeFrontwSize2() {
        ...
        assertEquals(lst.remove(0), (Integer) 0);
        assertEquals("1", printListForwards(lst));
        assertEquals("1", printListBackwards(lst));
    ...
    public void removeBackwSize5() {
        ...
        assertEquals("0123", printListForwards(lst));
        assertEquals("3210", printListBackwards(lst));
        assertEquals(lst.size(), 4);
    ...
    public void removeBackwSize2() {
        ...
        assertEquals("0", printListForwards(lst));
        assertEquals("0", printListBackwards(lst));
        assertEquals(lst.size(), 1);
    ...
    public void testToString() {
        shortList = new MyLinkedList<>();
        assertEquals(shortList.toString(), "[]");
        shortList.add("A");
        shortList.add("B");
